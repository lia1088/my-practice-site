      ...
      <Container>
        ...
        >
          ...
          <div className="flex flex-1 flex-col justify-center p-8 md:p-10">
            ...
            <h3 className="font-heading text-2xl font-black text-foreground leading-snug group-hover:text-[var(--brand-primary)] transition-colors md:text-3xl">
              {featured.title}
            </h3>
          ...
          {regular.map((event) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <h3 className="font-heading text-base font-bold text-foreground leading-snug group-hover:text-[var(--brand-primary)] transition-colors">
                  {event.title}
                </h3>
